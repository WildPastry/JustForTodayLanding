...
const Home: React.FC = (): JSX.Element => {
  return (
    <section>
      <h1
        style={{ textShadow: `3px 3px var(--darkBlue)` }}
        className='text-center text-2xl mt-4 mb-8 min850:text-3xl min850:mb-12'>
        AA literature at the touch of a button
      </h1>
      ...
      <div className='flex justify-center items-center mt-10'>
        <FaArrowRight
          className='text-spotBlue mr-10 min460max674:hidden max460:hidden'
          fontSize={60}
        />
        <Badges />
      </div>
