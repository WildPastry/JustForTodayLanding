    ...
    <section>
      <div className='flex flex-col max-w-screen-xl m-auto'>
        ...
        <p>
          ...
          video, text, photographs, and graphics on the App (collectively, the
          ...
          and are protected by copyright and trademark laws. The Content and the
          Marks are provided on the App “AS IS” for your information and
          personal use only. Except as expressly provided in these Terms and
          Conditions, no part of the App and no Content or Marks may be copied,
          reproduced, aggregated, republished, uploaded, posted, publicly
          displayed, encoded, translated, transmitted, distributed, sold,
          licensed, or otherwise exploited for any commercial purpose
          whatsoever, without our express prior written permission. Provided
          that you are eligible to use the App, you are granted a limited
          license to access and use the App and to download or print a copy of
          ...
          not expressly granted to you in and to the App, the Content and the
          Marks.
        </p>
        <h3 className='text-3xl text-spotBlue mb-3 mt-8'>USER REGISTRATION</h3>
        <p>
        ...
        <h3 className='text-3xl text-spotBlue mb-3 mt-8'>
        ...
        <ol>
          ...
          <li>
            ...
            otherwise use the App and/or the Content for any revenue-generating
            endeavour or commercial enterprise.
          </li>
          <li>
            (14) decipher, decompile, disassemble, or reverse engineer any of
            the software comprising or in any way making up a part of the App.
          </li>
          <li>
            (15) attempt to bypass any measures of the App designed to prevent
          ...
          <li>
            ...
            enjoyment of the App or modifies, impairs, disrupts, alters, or
          ...
          <li>
            ...
            cheat utility, scraper, or offline reader that accesses the App, or
        ...
        <ol>
          ...
          <li>
            ...
            application license contained in these Terms and Conditions, and
        ...
        <h3 className='text-3xl text-spotBlue mb-3 mt-8'>SUBMISSIONS</h3>
        <p>
          You acknowledge and agree that any questions, comments, suggestions,
          ideas, feedback, or other information regarding the App
        ...
        <h3 className='text-3xl text-spotBlue mb-3 mt-8'>ADVERTISERS</h3>
        <p>
          ...
          App and any services provided on the App or products sold through
        ...
        <h3 className='text-3xl text-spotBlue mb-3 mt-8'>APP MANAGEMENT</h3>
        <p className='mb-1'>
        ...
        <h3 className='text-3xl text-spotBlue mb-3 mt-8'>PRIVACY POLICY</h3>
        <p>
          ...
          advised the App is hosted in the United States. If you access the App
          ...
          through your continued use of the App, you are transferring your data
        ...
        <p>
          ...
          WITHOUT NOTICE OR LIABILITY, DENY ACCESS TO AND USE OF THE APP
          ...
          YOUR USE OR PARTICIPATION IN THE APP OR DELETE [YOUR ACCOUNT AND] ANY
        ...
        <p>
          ...
          part of the App without notice at any time. We will not be liable to
          you or any third party for any modification, price change, suspension,
          or discontinuance of the App. We cannot guarantee the App will be
          available at all times. We may experience hardware, software, or other
          problems or need to perform maintenance related to the App, resulting
          in interruptions, delays, or errors. We reserve the right to change,
          revise, update, suspend, discontinue, or otherwise modify the App at
          ...
          caused by your inability to access or use the App during any downtime
          or discontinuance of the App. Nothing in these Terms and Conditions
          will be construed to obligate us to maintain and support the App or to
          supply any corrections, updates, or releases in connection therewith.
        </p>
        <h3 className='text-3xl text-spotBlue mb-3 mt-8'>CORRECTIONS</h3>
        <p>
          ...
          or omissions and to change or update the information on the App at any
          time, without prior notice.
        </p>
        <h3 className='text-3xl text-spotBlue mb-3 mt-8'>DISCLAIMER</h3>
        <p>
          ...
          OR IMPLIED, IN CONNECTION WITH THE APP AND YOUR USE THEREOF,
          INCLUDING, WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF
          MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND
          NON-INFRINGEMENT. WE MAKE NO WARRANTIES OR REPRESENTATIONS ABOUT THE
          ACCURACY OR COMPLETENESS OF THE APP’S CONTENT OR THE CONTENT OF ANY
          WEBSITES LINKED TO THE APP AND WE WILL ASSUME NO LIABILITY OR
          RESPONSIBILITY FOR ANY (1) ERRORS, MISTAKES, OR INACCURACIES OF
          CONTENT AND MATERIALS, (2) PERSONAL INJURY OR PROPERTY DAMAGE, OF ANY
          NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF THE APP,
          ...
          THE APP, (5) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY
          BE TRANSMITTED TO OR THROUGH THE APP BY ANY THIRD PARTY, AND/OR (6)
          ...
          POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE APP. WE DO
          ...
          APP, ANY HYPERLINKED WEBSITE, OR ANY WEBSITE OR MOBILE APPLICATION
        ...
        <h3 className='text-3xl text-spotBlue mb-3 mt-8'>USER DATA</h3>
        <p>
          We will maintain certain data that you transmit to the App for the
          purpose of managing the App, as well as data relating to your use of
          the App. Although we perform regular routine backups of data, you are
          solely responsible for all data that you transmit or that relates to
          any activity you have undertaken using the App. You agree that we
        ...
        <h3 className='text-3xl text-spotBlue mb-3 mt-8'>MISCELLANEOUS</h3>
        <p>
          These Terms and Conditions and any policies or operating rules posted
          by us on the App constitute the entire agreement and understanding
          ...
          of such right or provision. These Terms and Conditions operate to the
          ...
          Terms and Conditions or use of the App. You agree that these Terms and
          Conditions will not be construed against us by virtue of having
          drafted them. You hereby waive any and all defences you may have based
          on the electronic form of these Terms and Conditions and the lack of
