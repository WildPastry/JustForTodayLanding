  ...
  return (
    <section className='w-700 m-auto'>
      ...
      <p className='text-md'>
        ...
        permission. Provided that you are eligible to use the App, you are
        granted a limited license to access and use the App and to download or
      ...
      <ol>
        ...
        <li>
          ...
          the App Distributor will have no other warranty obligation whatsoever
      ...
      <p className='text-md'>
        ...
        App, including, but not limited to, intellectual property rights,
      ...
      <p className='text-md'>
        ...
        NOTICE OR LIABILITY, DENY ACCESS TO AND USE OF THE APP (INCLUDING
        ...
        IN THE APP OR DELETE [YOUR ACCOUNT AND] ANY CONTENT OR INFORMATION THAT
      ...
      <p className='text-md'>
        ...
        of the App. We cannot guarantee the App will be available at all times.
        We may experience hardware, software, or other problems or need to
        perform maintenance related to the App, resulting in interruptions,
        delays, or errors. We reserve the right to change, revise, update,
        suspend, discontinue, or otherwise modify the App at any time or for any
        reason without notice to you. You agree that we have no liability
        whatsoever for any loss, damage, or inconvenience caused by your
        inability to access or use the App during any downtime or discontinuance
        of the App. Nothing in these Terms and Conditions will be construed to
      ...
      <p className='text-md'>
        ...
        OF THE APP, (3) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS
        AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR FINANCIAL INFORMATION
        STORED THEREIN, (4) ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR
        FROM THE APP, (5) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH
        MAY BE TRANSMITTED TO OR THROUGH THE APP BY ANY THIRD PARTY, AND/OR (6)
        ANY ERRORS OR OMISSIONS IN ANY CONTENT AND MATERIALS OR FOR ANY LOSS OR
        DAMAGE OF ANY KIND INCURRED AS A RESULT OF THE USE OF ANY CONTENT
        POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE APP. WE DO NOT
        WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY FOR ANY PRODUCT OR
        SERVICE ADVERTISED OR OFFERED BY A THIRD PARTY THROUGH THE APP, ANY
      ...
      <p className='text-md'>
        ...
        activity you have undertaken using the App. You agree that we shall have
      ...
      <p className='text-md'>
        ...
        the App. You agree that these Terms and Conditions will not be construed
        against us by virtue of having drafted them. You hereby waive any and
        all defences you may have based on the electronic form of these Terms
        and Conditions and the lack of signing by the parties hereto to execute
