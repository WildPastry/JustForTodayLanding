    ...
    <section className='mobileSmall:flex mobileSmall:flex-col'>
      {/* <div className='align-bottom inline-block me-10 mobileSmall:mb-5 mobileSmall:m-auto'>
        <a
          ...
          <img className='h-16 mobileLarge:h-14 mobileSmall:h-13' src={appleStoreBadge} alt='Apple Store Badge' />
        </a>
      </div> */}
      <div className='align-bottom inline-block mobileSmall:m-auto'>
        <a
          ...
          target='_blank'
          rel='noopener noreferrer'>
          <img className='h-16 mobileLarge:h-14 mobileSmall:h-13' src={googeStoreBadge} alt='Googe Store Badge' />
        </a>
      </div>
    </section>
  );
